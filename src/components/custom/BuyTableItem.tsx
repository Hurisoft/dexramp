...
function BuyTableItem({offer}: {offer: Offer}) {
  ...
  return (
      <TableRow>
        ...
        <TableCell>
          ...
          {openConnectModal ? (
              <Button className="w-full w-full bg-green-600 hover:bg-green-700" onClick={openConnectModal}>
                Buy {getTokenName()}
              </Button>
          ) : (
              <Dialog>
                <DialogTrigger className="w-full">
                  <Button className="w-full bg-green-600 hover:bg-green-700">Sell {getTokenName()}</Button>
                </DialogTrigger>
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>Buy {getTokenName()}</DialogTitle>
                    ...
                    <div ref={parent}>
                      <Card className="py-3 px-4">
                        <div className="flex flex-col gap-2">
                          ...
                          <div className="flex justify-between items-center">
                            <p className="text-xs">
                              Available: {offer.totalAmount} {getTokenName()}
                            </p>
                          </div>
                        </div>
                      </Card>
